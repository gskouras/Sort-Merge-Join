...
Between *between_update ( Between * , relation * , int  , int  , int  );

Between *fill_updated_jarrays ( Between * , int  , relation * , int  , int  , int , int ) ;

uint64_t **fill_already_joined_rels ( Between * , uint64_t ** , int  , int , int ) ;

uint64_t **fill_new_rel ( Between * , uint64_t ** , int  , int  , uint64_t  );

int calculate_new_between_size ( uint64_t * , relation * , int , int );

Between *between_fill_empty( Between * , relation * , int  , int  );





relation *build_relation_from_joined ( uint64_t * , int ,all_data * , int , int );

int calc_tuples_size_to_build_rel_from_joined(uint64_t *, int , int  , int ) ;
...
Between *scan ( Between * , all_data * , int  , int  , int  , int , int , int , int ) ;

int calculate_scan_size ( uint64_t * , all_data * , uint64_t * , int  , int , int ,int , int );
